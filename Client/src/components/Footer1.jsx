...
const Footer1 = ({ className = "" }) => {
  return (
    <footer
      className={`self-stretch bg-black flex flex-col items-end justify-start pt-[71px] px-0 pb-5 box-border gap-[73.8px] max-w-full z-[2] text-left text-2xl text-white font-inter mq450:gap-[18px] mq450:pt-[30px] mq450:box-border mq1125:pt-[46px] mq1125:box-border mq800:gap-[37px] ${className}`}
    >
      <div className="self-stretch flex flex-row items-start justify-end py-0 pr-[69px] pl-[71px] box-border max-w-full font-satoshi mq800:pl-[35px] mq800:pr-[34px] mq800:box-border">
        <div className="flex-1 flex flex-row items-start justify-between max-w-full gap-[20px] mq1300:flex-wrap">
          <div className="flex flex-row items-start justify-start gap-[153px] min-w-[836.8px] max-w-full mq450:gap-[38px] mq1125:flex-wrap mq1125:gap-[76px] mq1125:min-w-full mq1300:flex-1">
            <div className="w-[131px] flex flex-col items-start justify-start gap-[19.6px]">
              ...
              <div className="w-[111.4px] flex flex-col items-start justify-start gap-[9.5px] text-mid-1">
                ...
                <div className="w-[54.7px] relative text-base-7 leading-[30.4px] flex items-center">
                  Privacy
                </div>
              </div>
            </div>
      ...
      <div className="w-[497px] flex flex-row items-start justify-center py-0 px-5 box-border max-w-full text-base-8 text-dimgray">
      ...
      <div className="self-stretch flex flex-col items-start justify-start gap-[16.4px] max-w-full text-smi-9">
        ...
        <div className="self-stretch flex flex-row items-start justify-start pt-0 pb-[10.6px] pr-[70px] pl-[69px] box-border max-w-full mq800:pl-[34px] mq800:pr-[35px] mq800:box-border">
          <header className="flex-1 flex flex-row items-start justify-between max-w-full gap-[20px] mq1125:flex-wrap">
            <img
        ...
        <div className="w-[413.7px] flex flex-row items-start justify-start py-0 px-[71px] box-border max-w-full mq450:pl-5 mq450:pr-5 mq450:box-border">
          <div className="flex-1 relative leading-[21px] shrink-0">
            © 2024 Lorem ipsum
          </div>
        </div>
      </div>
